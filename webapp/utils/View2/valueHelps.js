    ...
    return {
        ...
        onCustomerCodeHelp: function (oControl) { 
            if (!oControl.CustomerCodeFrag) {
                oControl.CustomerCodeFrag = sap.ui.xmlfragment("zpj.pro.sk.sd.salesco.zprosalesco.view.fragments.View2.F4s.customerCodF4", oControl);
        ...
        onSalesOfficeHelp: function (oControl) {
            ...
            if (!oControl.SalesOfficerag) {
                oControl.SalesOfficerag = sap.ui.xmlfragment("zpj.pro.sk.sd.salesco.zprosalesco.view.fragments.View2.F4s.salesOfficeF4", oControl);
        ...
        onMaterialFreightGroupsHelp: function (oControl, Division) {
            ...
            if (!oControl.oFragment) {
                oControl.oFragment = sap.ui.xmlfragment("zpj.pro.sk.sd.salesco.zprosalesco.view.fragments.View2.F4s.materialFreightGroupsF4", oControl);
        ...
        onSizesHelp: function (oControl) {
            ...
            if (!oControl.oFragmentSizes) {
                oControl.oFragmentSizes = sap.ui.xmlfragment("zpj.pro.sk.sd.salesco.zprosalesco.view.fragments.View2.F4s.sizesF4", oControl);
        ...
        onSupplyPlantHelp: function (oControl) {
            ...
            if (!oControl.oFragmentSupply) {
                oControl.oFragmentSupply = sap.ui.xmlfragment("zpj.pro.sk.sd.salesco.zprosalesco.view.fragments.View2.F4s.supplyingPlantF4", oControl);
        ...
        onManufacturingAmtHelp: function (oControl) {
            ...
            if (!oControl.oFragmentMan) {
                oControl.oFragmentMan = sap.ui.xmlfragment("zpj.pro.sk.sd.salesco.zprosalesco.view.fragments.View2.F4s.manufacturingAmountF4", oControl);
