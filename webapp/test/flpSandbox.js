		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpjprosksdsalescozprosalesco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpjprosksdsalescozprosalesco-display": {
								"semanticObject": "zpjprosksdsalescozprosalesco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sk.sd.salesco.zprosalesco",
									"url": sap.ui.require.toUrl("zpj/pro/sk/sd/salesco/zprosalesco")
								}
							}
						}
					}
